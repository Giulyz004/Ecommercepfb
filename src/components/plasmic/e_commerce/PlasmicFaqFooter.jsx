...
import sty from "./PlasmicFaqFooter.module.css"; // plasmic-import: 1-w3pXaT6XGtNk/css
...
function PlasmicFaqFooter__RenderFunc(props) {
  ...
  return (
    ...
    >
      {true ? (
        <div className={classNames(projectcss.all, sty.freeBox__rRHjE)}>
          <div className={classNames(projectcss.all, sty.columns__mpWPd)}>
            <div className={classNames(projectcss.all, sty.column__a18Ib)}>
              <p.PlasmicImg
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.column___8W824)}
            >
              <h1
              ...
              <div className={classNames(projectcss.all, sty.columns__f07W)}>
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.column__xWjK)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.column__tfmVx)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
                  ...
                  {(
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__lMwyT)}
                    >
                      {(
                        hasVariant(globalVariants, "screen", "mobile")
                          ? true
                ...
                <div
                  className={classNames(projectcss.all, sty.column__gF2Mk)}
                />
              </div>
            </p.Stack>
          </div>
      ...
      {true ? (
        <div className={classNames(projectcss.all, sty.freeBox__jyPHh)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__lqfdw)}
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___38E0N)}
            >
              {(
                hasVariant(globalVariants, "screen", "mobile") ? true : true
              ) ? (
              ...
              {true ? (
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__j9B64)}
                >
                  <LogoWhitesvgIcon
                    className={classNames(projectcss.all, sty.svg__mlWhx)}
                    role={"img"}
                  />
              ...
              <div className={classNames(projectcss.all, sty.freeBox___2CifV)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
