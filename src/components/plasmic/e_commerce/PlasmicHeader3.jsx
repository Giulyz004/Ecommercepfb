...
import sty from "./PlasmicHeader3.module.css"; // plasmic-import: OoSlqgr6dmegGF/css
...
function PlasmicHeader3__RenderFunc(props) {
  ...
  return true ? (
    ...
    >
      ...
      <LogoWhitesvgIcon
        className={classNames(projectcss.all, sty.svg__bEhjw)}
        role={"img"}
      />
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__yExMt)}
        >
          <a
            className={classNames(
              projectcss.all,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__exlze)}
      >
        <IconLink
          ...
          icon={
            <React.Fragment>
              <IconIcon
                className={classNames(projectcss.all, sty.svg__b0IVl)}
                role={"img"}
              />
