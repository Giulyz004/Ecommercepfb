...
function PlasmicFeatureItem__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__fVl8D)}>
        <div className={classNames(projectcss.all, sty.freeBox__eJ4CZ)} />
        <div className={classNames(projectcss.all, sty.freeBox__i0I87)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__geuIi)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__cbTsA)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__shyRl)}
            >
              <LinkButton
